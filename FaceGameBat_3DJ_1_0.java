...
public class FaceGameBat_3DJ_1_0 extends JFrame {
	...
	public void document() {
		...
		// Button ImageIcon
		newfile.setIcon(new ImageIcon("File_Logo/newfile.png"));
		...
		// Button ImageIcon
		openfile.setIcon(new ImageIcon("File_Logo/openfile.png"));
		...
		openfile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				FileDialog fedg1 = new FileDialog(f1, "Open", FileDialog.LOAD);
